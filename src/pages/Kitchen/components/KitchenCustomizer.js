      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between">
        <Box>
          ...
          <Typography variant="body2" color="text.secondary">
            Secili urunun olcu ve malzemeleri.
          </Typography>
        </Box>
        ...
        <>
          ...
          <Grid container spacing={1}>
            <Grid item xs={6}>
              <TextField
                ...
                onChange={(event) =>
                  onChangeDimension(selectedSceneIndex, "width", event.target.value)
                }
              />
            </Grid>
            <Grid item xs={6}>
              <TextField
                ...
                onChange={(event) =>
                  onChangeDimension(selectedSceneIndex, "height", event.target.value)
                }
              />
            </Grid>
          </Grid>
          ...
          {["base_cabinet", "wall_cabinet"].includes(selectedProduct.category) && (
            <TextField
              ...
              onChange={(event) =>
                onChangeOption(selectedSceneIndex, "door_material_id", event.target.value)
              }
              size="small"
            >
              {materials
          ...
          {selectedProduct.category === "wall_cabinet" && (
            <TextField
              ...
              onChange={(event) =>
                onChangeOption(selectedSceneIndex, "glass_material_id", event.target.value)
              }
              size="small"
            >
              {materials
          ...
          {selectedProduct.category === "countertop" && (
            <TextField
              ...
              onChange={(event) =>
                onChangeOption(selectedSceneIndex, "countertop_material_id", event.target.value)
              }
              size="small"
            >
              {materials
          ...
          <Box>
            ...
            >
              <IconButton
                ...
                sx={{ bgcolor: "#FFFFFF", boxShadow: "0 6px 14px rgba(15,23,42,0.08)" }}
              >
