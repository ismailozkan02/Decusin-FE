...
export const SERVER = {
  ...
  kitchen: {
    ...
    seedCatalogItems: path("kitchen", "catalog-items", "seed"),
    catalogItem: (id) => path("kitchen", "catalog-items", id),
    catalogStats: path("kitchen", "catalog-stats"),
    catalogCategories: path("kitchen", "catalog-categories"),
    catalogCategory: (id) => path("kitchen", "catalog-categories", id),
    materials: path("kitchen", "materials"),
    material: (id) => path("kitchen", "materials", id),
    upload: (type) => path("kitchen", "uploads", type),
